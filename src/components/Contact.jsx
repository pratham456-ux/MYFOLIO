              ...
              <div className='space-y-4 sm:space-y-6'>
                <div className='flex items-start'>
                  ...
                  <div>
                    ...
                    <a href="mailto:mjmehta2004@gmail.com" className='text-gray-300 hover:text-white transition-colors duration-300 text-sm sm:text-base break-words'>prthamparikh45@gmail.com</a>
                  </div>
                </div>
                ...
                <div className='flex items-start'>
                  ...
                  <div>
                    ...
                    <a href="tel:+917203820127" className='text-gray-300 hover:text-white transition-colors duration-300 text-sm sm:text-base'>+91 7265830809</a>
                  </div>
                </div>
